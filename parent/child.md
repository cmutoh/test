...
![default-layout-settings-target][default-layout-settings-target]
...
![default-layout-settings-tab-list][default-layout-settings-tab-list]
...
![default-layout-settings-edit-tab-role][default-layout-settings-edit-tab-role]

初期画面設定は、ロール(ユーザの所属情報)に対して設定します。
すべてのユーザが同じ初期画面を利用する場合は「defaultRole」のみ使用します。
設定対象のロールの行にある 編集アイコンをクリックすると、初期画面設定ウィンドウが表示されます。

![default-layout-settings-edit][default-layout-settings-edit]
...
![default-layout-settings-commandbar-role][default-layout-settings-commandbar-role]

設定対象のロールの行にある 編集アイコンをクリックすると、コマンドバー編集画面が表示されます。

![default-layout-settings-commandbar-edit][default-layout-settings-commandbar-edit]
...
![default-layout-settings-header-role][default-layout-settings-header-role]

設定対象のロールの行にある 編集アイコンをクリックすると、ヘッダーHTML編集ダイアログが表示されます。

![default-layout-settings-header-html][default-layout-settings-header-html]
...
[default-layout-settings-tab-list]: images/default-layout-settings/default-layout-settings-tab-list.png "タブ一覧画面"
[default-layout-settings-edit-tab-role]: images/default-layout-settings/default-layout-settings-edit-tab-role.png "ロール設定画面（タブ）"
[default-layout-settings-edit]: images/default-layout-settings/default-layout-settings-edit.png "初期画面設定ウィンドウ"
[default-layout-settings-commandbar-role]: images/default-layout-settings/default-layout-settings-commandbar-role.png "ロール設定画面（コマンドバー）"
[default-layout-settings-commandbar-edit]: images/default-layout-settings/default-layout-settings-commandbar-edit.png "コマンドバー編集画面"
[default-layout-settings-header-role]: images/default-layout-settings/default-layout-settings-header-role.png "ロール設定画面（ヘッダ）"
[default-layout-settings-header-html]: images/default-layout-settings/default-layout-settings-header-html.png "ヘッダーHTML編集ダイアログ"
